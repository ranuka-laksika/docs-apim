...
**Important:** After accessing Choreo Insights, make sure to select the correct analytics environment from the dropdown in the top-right corner of the page. Select the same environment name that you provided when generating the key in Step 2 (e.g., customer1-dev).
