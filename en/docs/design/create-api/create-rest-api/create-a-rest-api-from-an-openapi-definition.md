...
2. Click **Create API** and then click **Import OpenAPI**.
    ...
    [![Create an API](/en/4.4.0/assets/img/learn/import-open-api.png)](/en/4.4.0/assets/img/learn/import-open-api.png)
...
3. Select one of the following options:
	...
	* **OpenAPI Archive/File** - If you select this option, drag and drop or click **Browse File to Upload** to upload either an individual OpenAPI definition or an archive that has an OpenAPI definition with external <a href="https://Swagger.io/docs/specification/using-ref/" target="_blank">file references</a>.
    ...
    <p class="admonition-title">Note</p>
    <p>
    <ul><li>You need to upload an archive if you have remote references in your API definition. - <a href="/en/4.4.0/assets/attachments/design/sample-archive.zip">Sample OpenAPI archive</a></li><li>If it is a single Swagger file without remote references, it can be imported directly, without zipping.</li><li> 
...
4.  Select **OpenAPI URL** and provide `https://petstore3.swagger.io/api/v3/openapi.json` as the URL. Click **Next**.
    ...
    ??? tip "If you want to work with the Swagger 2.0 definition instead of the OpenAPI 3.0 definition"
     ...
     [![Create a REST API using swagger definition](/en/4.4.0/assets/img/learn/create-rest-api-using-swagger-def-form1.png){: style="width:70%"}](/en/4.4.0/assets/img/learn/create-rest-api-using-swagger-def-form1.png)
...
5.  Edit the information as given below and click **Create**.
    ...
    ??? tip "If you want to work with the Swagger 2.0 definition instead of the OpenAPI 3.0 definition"
     ...
     [![Create a REST API using swagger definition](/en/4.4.0/assets/img/learn/create-rest-api-using-swagger-def-form2.png){: style="width:70%"}](/en/4.4.0/assets/img/learn/create-rest-api-using-swagger-def-form2.png)

     The Petstore API overview page appears.

     [![Overview of created API](/en/4.4.0/assets/img/learn/overviewpage-rest-api-creating-by-swagger-def.png)](/en/4.4.0/assets/img/learn/overviewpage-rest-api-creating-by-swagger-def.png)
...
[![](/en/4.4.0/assets/img/learn/resource-of-pet-store-api.png)](/en/4.4.0/assets/img/learn/resource-of-pet-store-api.png)
...
1. Click **API Configurations**, **API Definition**, and then click **Edit** to remove the security headers. 
     ...
     [![](/en/4.4.0/assets/img/learn/edit-api-definition-pet-store.png)](/en/4.4.0/assets/img/learn/edit-api-definition-pet-store.png)
    ...
    ??? note "Importing an API definition"
        ...
        [![Import API Definition](/en/4.4.0/assets/img/learn/import-api-definition.png)](/en/4.4.0/assets/img/learn/import-api-definition.png)        
...
4.  After removing the security tags, click **Update Content**.
     ...
     [![Update OpenAPI definition](/en/4.4.0/assets/img/learn/update-content-pet-store.png)](/en/4.4.0/assets/img/learn/update-content-pet-store.png)
...
2. Enter the information shown below.
     ...
     <html>
     <img src="/en/4.4.0/assets/img/learn/endpoint-menu.png" width="200">
     </html>
...
3. Click **Save** to save the changes.
    ...
    !!! note
     ...
     [![](/en/4.4.0/assets/img/learn/add-endpoint-configuration-for-pet-store-api.png)](/en/4.4.0/assets/img/learn/add-endpoint-configuration-for-pet-store-api.png)
...
<a href="/en/4.4.0/assets/img/learn/runtime-config-menu.png"><img src="/en/4.4.0/assets/img/learn/runtime-config-menu.png" width="20%"></a>

<a href="/en/4.4.0/assets/img/learn/transport-level-security-pet-store.png"><img src="/en/4.4.0/assets/img/learn/transport-level-security-pet-store.png" width="90%">
</a>
...
1. Click **Portal Configurations** and click **Subscriptions** to navigate to the Business Plans page.
     ...
     <a href="/en/4.4.0/assets/img/learn/subscriptions-menu.png">
     <img src="/en/4.4.0/assets/img/learn/subscriptions-menu.png" alt="subscriptions menu" width="20%">
     </a>
...
3. Click **Save**
    ...
    [![Business Plans page](/en/4.4.0/assets/img/learn/add-bussiness-plans-for-pet-store-api.png)](/en/4.4.0/assets/img/learn/add-bussiness-plans-for-pet-store-api.png)


Now, a REST API from an OpenAPI Definition has been created and configured successfully. 

Next, [deploy the API](/en/4.4.0/deploy-and-publish/deploy-on-gateway/deploy-api/deploy-an-api/), [test the API](/en/4.4.0/design/create-api/create-rest-api/test-a-rest-api/), and finally [publish the API](/en/4.4.0/deploy-and-publish/publish-on-dev-portal/publish-an-api).

## See Also

Learn more on the concepts that you need to know when creating a REST API:

-   [Endpoints](/en/4.4.0/design/endpoints/endpoint-types/)
-   [API Security](/en/4.4.0/design/api-security/api-authentication/secure-apis-using-oauth2-tokens/)
-   [Rate Limiting](/en/4.4.0/design/rate-limiting/introducing-throttling-use-cases/)
-   [Life Cycle Management](/en/4.4.0/design/lifecycle-management/api-lifecycle/)
-   [API Monetization](/en/4.4.0/design/api-monetization/monetizing-an-api/)
-   [API Visibility](/en/4.4.0/design/advanced-topics/control-api-visibility-and-subscription-availability-in-developer-portal/)
-   [API Documentation](/en/4.4.0/design/api-documentation/add-api-documentation/)
-   [Custom Properties](/en/4.4.0/design/create-api/adding-custom-properties-to-apis/)
