...
1.  Download TCPMon from the following location: [tcpmon-1.0-bin.zip](http://archive.apache.org/dist/ws/tcpmon/1.0/tcpmon-1.0-bin.zip){:download="tcpmon-1.0-bin.zip"}.
