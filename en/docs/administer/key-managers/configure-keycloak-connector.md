         ...
         <table>
          ...
          <tr class="even">
            ...
            <td>The issuer that consumes or validates the access tokens
               ...
               https://localhost:8080/auth/realm</td>
          <td>Mandatory</td>
          </tr>
          <tr class="odd">
          ...
          <tr class="odd">
            ...
            https://localhost:8080/auth/realms/master/protocol/openid-connect/token/introspect </br>
          ...
          <tr class="even">
            ...
            e.g.,
            https://localhost:8080/auth/realms/master/protocol/openid-connect/token</br>
