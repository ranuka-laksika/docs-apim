...
!!! note
    The GitHub and Discord URLs will appear in the Developer Portal only if the [API Publisher has defined these URLs for the API.]({{base_path}}/design/api-collaborations/enable-social-media-interaction/#add-github-and-discord-channel-urls-to-an-api)
