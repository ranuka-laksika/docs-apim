...
-   [Configuring Azure AD Federated Authentication for Publisher and Developer Portal]({{base_path}}/develop/extending-api-manager/saml2-sso/configuring-azure-ad-federated-authentication)
