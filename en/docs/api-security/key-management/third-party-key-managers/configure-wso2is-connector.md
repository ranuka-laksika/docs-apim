...
5. Add the Key Manager configurations.
     ...
     The following table provides definitions for each configuration.
      ...
      <td>When enabled, allows configuring application-level scopes for OAuth applications. Application scopes can be requested during token generation using the client credentials grant type. For more information, see <a href="{{base_path}}/api-security/runtime/authorization/oauth2-scopes/application-scopes">Application Scopes</a>.</td>
      <td>Optional</td>
      </tr>
      <tr class="even">
