...
4. Run `npm start` to start the server.
    ...
    [![CLI output](/en/4.6.0/assets/img/learn/cli-output.png){: style="width:45%"}](/en/4.6.0/assets/img/learn/cli-output.png)
...
4. Enter the GraphQL API related details and click **Create**.
    ...
    [![Add GraphQL API details](/en/4.6.0/assets/img/learn/create-graphql-api-details.png){: style="width:75%"}](/en/4.6.0/assets/img/learn/create-graphql-api-details.png)
...
5. Optionally, modify the existing GraphQL schema definition.
    ...
    2. Click **Download Definition**.
         ...
         [![Add schema definition](/en/4.6.0/assets/img/learn/download-schema-definition.png){: style="width:80%"}](/en/4.6.0/assets/img/learn/download-schema-definition.png)
    ...
    2. Update the operations as required.
        ...
        1. **Create scopes**.
            ...
            2. Enter the required details.
                   ...
                   <p class="admonition-title">Note</p>
                   <p> 
                   <ul><li>The role that you enter <b>should be a valid role that already exists in WSO2 API Manager</b>. Make sure to assign the role to the user. </li><li>For more information, see <a href="/en/4.6.0/administer/managing-users-and-roles/managing-users/">Adding Users</a> and <a href="/en/4.6.0/administer/managing-users-and-roles/managing-user-roles/">Adding User Roles</a>.</li></ul>
                   </p>
                   </div>
