...
!!! note "Admin Configuration"
    Administrators can configure blocking policies by following the instructions in the [API Governance Admin Capabilities]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy) guide.
