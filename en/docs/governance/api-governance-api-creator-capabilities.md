...
!!! note
    Administrators can configure blocking policies by creating new policies. For more information on how to create and configure policies, refer to [API Governance Admin Capabilities]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy).
