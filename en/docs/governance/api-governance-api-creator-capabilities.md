...
!!! note "Configuring Blocking Policies"
    To configure blocking policies as an administrator, refer to [Create a New Policy]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy) in the admin capabilities documentation.
