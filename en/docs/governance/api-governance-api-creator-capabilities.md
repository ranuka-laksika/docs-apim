...
!!! note
    For information on how administrators can configure blocking policies, refer to [Create a New Policy]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy) in the API Governance Admin Capabilities documentation.
