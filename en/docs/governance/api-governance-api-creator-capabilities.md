...
!!! note "Configuring Blocking Policies"
    To configure blocking policies for governance compliance, administrators should refer to [Create a new Policy]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy) section in the API Governance Admin Capabilities guide.
