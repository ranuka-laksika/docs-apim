...
!!! note "Configuring Blocking Policies"
    For information on how to configure blocking policies as an administrator, see [Create a new Policy]({{base_path}}/governance/api-governance-admin-capabilities/#create-a-new-policy).
