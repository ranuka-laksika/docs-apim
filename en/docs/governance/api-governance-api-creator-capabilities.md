...
!!! note "Configure Blocking Policies"
    For information on how to configure blocking policies as an administrator, see [Create and Manage Policies]({{base_path}}/governance/api-governance-admin-capabilities/#create-and-manage-policies).
